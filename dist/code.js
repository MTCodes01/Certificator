"use strict";(()=>{var E=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports);var p=(e,t,a)=>new Promise((n,o)=>{var i=s=>{try{g(a.next(s))}catch(m){o(m)}},c=s=>{try{g(a.throw(s))}catch(m){o(m)}},g=s=>s.done?n(s.value):Promise.resolve(s.value).then(i,c);g((a=a.apply(e,t)).next())});var v=E(w=>{figma.showUI(`<!DOCTYPE html>\r
<html lang="en">\r
\r
<head>\r
